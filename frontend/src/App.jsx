...
function Header() {
  return (
    <header
      className="sticky top-0 z-30 backdrop-blur-xl bg-white/75 border-b border-[#E2E8F0]"
...
function Hero() {
  return (
    <section className="relative overflow-hidden grain">
      <div className="max-w-[1440px] mx-auto px-8 pt-14 pb-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <motion.div
